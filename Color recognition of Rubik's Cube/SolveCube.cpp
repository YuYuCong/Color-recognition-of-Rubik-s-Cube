...
//*
//* Filename                : SoveCube.cpp
//* Description             : (编译环境：win10 + OpenCV3.3.0 + VS2017)
//* Reference               : JohnnyX.cpp download from http://tomas.rokicki.com/cubecontest/winners.html
//* Programmer(s)           : William Yu, windmillyucong@163.com
//* Company                 : HUST ThinkFly Studio
//* Modification History	  : ver1.0, 2018.01.30, William Yu
//*
//* Thinks JohnnyX a lot for this .cpp program,which is all his masterpiece,and benefit me a lot.
//* 我只是添加、改动了部分语句和注释，版权归原作者所有，请勿随意转载或修改。
//=====================================================================================*/

/**********************************************************************
*                             ==  My notes ==
*
* Question1：What`s BFS?
* You might get something useful from here: http://blog.csdn.net/furturerock/article/details/5568305
*
**********************************************************************/
